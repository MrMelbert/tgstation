...
/mob/living/carbon/human/reagent_check(datum/reagent/special_reagent, delta_time, times_fired)
	return dna.species.handle_chemicals(special_reagent, src, delta_time, times_fired)
