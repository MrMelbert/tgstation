...
/datum/species/proc/handle_mutant_bodyparts(mob/living/carbon/human/H, forced_colour)
	...
	for(var/X in H.bodyparts)
		...
		if(H.wear_suit && ((H.wear_suit.flags_inv & HIDEJUMPSUIT) || ((H.wear_suit.body_parts_covered & LEGS) && !H.wear_suit.should_not_squish)) || ((H.w_uniform && (H.w_uniform.body_parts_covered & LEGS) && !H.w_uniform.should_not_squish))) // NON-MODULE CHANGE
