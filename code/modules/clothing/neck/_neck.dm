...
/obj/item/clothing/neck/petcollar/mob_can_equip(mob/equipping, slot, disable_warning = FALSE, bypass_equip_delay_self = FALSE, ignore_equipped = FALSE, indirect_action = FALSE)
	if(!ismonkey(equipping) && !human_wearable)
		return FALSE
	return ..()
