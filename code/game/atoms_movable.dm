/atom/movable
	...
	/// What atom we are currently pulling / grabbing
	VAR_FINAL/atom/movable/pulling
	/// The state of our pull / grab, only really matters for living mobs
	VAR_FINAL/grab_state = GRAB_PASSIVE
